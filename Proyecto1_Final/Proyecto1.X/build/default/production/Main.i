...
debounce:
    banksel PORTB
    btfss PORTB, 3
    bsf banderas_antirrebote, 3 ;push en ((PORTB) and 07Fh), 3
    btfss PORTB, 4
    bsf banderas_antirrebote, 4 ;push en ((PORTB) and 07Fh), 4
    btfss PORTB, 5
    bsf banderas_antirrebote, 5 ;push en ((PORTB) and 07Fh), 5
    bcf INTCON, 0
